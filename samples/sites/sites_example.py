...
class SitesExample(object):
  ...
  def PromptDomain(self):
    return input(('If your Site is hosted on a Google Apps domain, '
    ...
    try:
      while True:
        ...
        if choice == 1:
          ...
          url = input('Enter the URL of the attachment: ')
          content_type = input("Enter the attachment's mime type: ")
          title = input('Enter a title for the web attachment: ')
          ...
          page_title = input('Enter a title for the file: ')
          description = input('Enter a description: ')
          ...
          summary = input('Enter a description: ')
          theme = input('Theme name (ex. "default"): ')
